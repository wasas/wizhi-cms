            ...
            <div id="save-action">
                ...
                switch ($__post->post_status)
                {
                    ...
                    default:
                        ...
                        {
                        ?>
                        <input <?php if ('private' == $__post->post_status) { ?>style="display:none"<?php } ?> type="submit" name="save" id="save-post" value="<?php esc_attr_e('Save Draft'); ?>" class="button" />
                        <?php
                        }
                        break;
                }
            ...
            <div class="misc-pub-section misc-pub-post-status">
                ...
                ?>
                    ...
                    <div id="post-status-select" class="hide-if-js">
                        ...
                        ?>
                        {!! \Wizhi\Facades\Form::select('post_status', [$choices], $__post->post_status, ['id' => 'post_status']) !!}
