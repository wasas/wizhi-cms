...
class PostTypeBuilder implements IPostType
{
     ...
     *
     * @return \Wizhi\PostType\PostTypeBuilder
     */
    ...
    protected function exposeStatuses()
    {
        ...
        $this->filter->add('wizhiAdminGlobalObject', function ($data) use ($self) {
            $cpt = new \stdClass();

            // Add the defined statuses.
            $cpt->statuses = $self->status;

            $data['_wizhiPostTypes'][$self->get('name')] = $cpt;
