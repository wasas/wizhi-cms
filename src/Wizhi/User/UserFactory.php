...
use Wizhi\Field\FieldException;
use Wizhi\Hook\IHook;
use Wizhi\Validation\IValidate;
...
class UserFactory extends Wrapper implements IUser
{
     ...
     * @param string $email
     *
     * @return \Wizhi\User\User | \WP_Error
     */
     ...
     * @param array $fields
     *
     * @throws \Wizhi\User\UserException
     */
    ...
    public function displayFields($user)
    {
        ...
        if (!static::$hasNonce) {
            wp_nonce_field('user', '_wizhinonce');
    ...
    public function saveFields($id, $oldData = [])
    {
        ...
        // Check nonces
        $nonceName = (isset($_POST['_wizhinonce'])) ? $_POST['_wizhinonce'] : '_wizhinonce';
