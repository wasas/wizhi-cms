...
class FieldFactory
{
     ...
     *
     * @return object Wizhi\Field\Fields\IField
     */
     ...
     *
     * @return \Wizhi\Field\Fields\TextField
     */
    public function text($name, array $features = [], array $attributes = [])
    {
        ...
        return $this->make('Wizhi\\Field\\Fields\\TextField', $properties);
    }
     ...
     * @param array  $attributes Input html attributes.
     *
     * @return \Wizhi\Field\Fields\PasswordField
     */
    public function password($name, array $features = [], array $attributes = [])
    {
        ...
        return $this->make('Wizhi\\Field\\Fields\\PasswordField', $properties);
    }
     ...
     * @param array  $attributes Input html attributes.
     *
     * @return \Wizhi\Field\Fields\NumberField
     */
    public function number($name, array $features = [], array $attributes = [])
    {
        ...
        return $this->make('Wizhi\\Field\\Fields\\NumberField', $properties);
    }
     ...
     * @param array  $attributes Input html attributes.
     *
     * @return \Wizhi\Field\Fields\EmailField
     */
    public function email($name, array $features = [], array $attributes = [])
    {
        ...
        return $this->make('Wizhi\\Field\\Fields\\EmailField', $properties);
    }
     ...
     * @param array  $attributes Input html attributes.
     *
     * @return \Wizhi\Field\Fields\DateField
     */
    public function date($name, array $features = [], array $attributes = [])
    {
        ...
        return $this->make('Wizhi\\Field\\Fields\\DateField', $properties);
    }
     ...
     * @param array  $attributes Input html attributes.
     *
     * @return \Wizhi\Field\Fields\TextareaField
     */
    public function textarea($name, array $features = [], array $attributes = [])
    {
        ...
        return $this->make('Wizhi\\Field\\Fields\\TextareaField', $properties);
    }
     ...
     * @param array        $attributes Input html attributes.
     *
     * @return \Wizhi\Field\Fields\CheckboxField
     */
    public function checkbox($name, $options, array $features = [], array $attributes = [])
    {
        ...
        return $this->make('Wizhi\\Field\\Fields\\CheckboxField', $properties);
    }
     ...
     * @param array        $attributes Input html attributes.
     *
     * @return \Wizhi\Field\Fields\RadioField
     */
    public function radio($name, $options, array $features = [], array $attributes = [])
    {
        ...
        return $this->make('Wizhi\\Field\\Fields\\RadioField', $properties);
    }
     ...
     * @param array  $attributes Input html attributes.
     *
     * @return \Wizhi\Field\Fields\SelectField
     */
    public function select($name, array $options, array $features = [], array $attributes = [])
    {
        ...
        return $this->make('Wizhi\\Field\\Fields\\SelectField', $properties);
    }
     ...
     *
     * @return \Wizhi\Field\Fields\MediaField
     */
    public function media($name, array $features = [])
    {
        $properties = [
            'features' => $features,
            'atts' => ['class' => 'wizhi-media-input', 'data-field' => 'media'],
            'name' => $name,
        ];

        return $this->make('Wizhi\\Field\\Fields\\MediaField', $properties);
    }
     ...
     *
     * @return \Wizhi\Field\Fields\InfiniteField
     */
    public function infinite($name, array $fields, array $features = [])
    {
        ...
        return $this->make('Wizhi\\Field\\Fields\\InfiniteField', $properties);
    }
     ...
     *
     * @return \Wizhi\Field\Fields\EditorField
     */
    public function editor($name, array $features = [], array $settings = [])
    {
        ...
        return $this->make('Wizhi\\Field\\Fields\\EditorField', $properties);
    }
     ...
     *
     * @return \Wizhi\Field\Fields\CollectionField
     */
    public function collection($name, array $features = [])
    {
        ...
        return $this->make('Wizhi\\Field\\Fields\\CollectionField', $properties);
    }
     ...
     * @param array  $attributes Input html attributes.
     *
     * @return \Wizhi\Field\Fields\ColorField
     */
    public function color($name, array $features = [], array $attributes = [])
    {
        $properties = [
            'features' => $features,
            'atts' => array_merge($attributes, ['class' => 'wizhi-color-field', 'data-field' => 'text']),
            'name' => $name,
        ];

        return $this->make('Wizhi\\Field\\Fields\\ColorField', $properties);
    }
}
