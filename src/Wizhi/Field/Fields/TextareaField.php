...
namespace Wizhi\Field\Fields;

use Illuminate\View\Factory;

class TextareaField extends FieldBuilder implements IField
{
    /**
    ...
    {
        return $this->view->make('metabox._wizhiTextareaField', ['field' => $this])->render();
    }
