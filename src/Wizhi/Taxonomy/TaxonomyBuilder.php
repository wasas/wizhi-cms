...
use Wizhi\Field\Wrapper;
use Wizhi\Hook\IHook;
use Wizhi\Validation\ValidationBuilder;
...
class TaxonomyBuilder extends Wrapper
{
     ...
     * @param \Wizhi\Validation\ValidationBuilder $validator
     ...
     *
     * @return \Wizhi\Taxonomy\TaxonomyBuilder
     */
    ...
    {
        $this->setNonce();
        echo $this->view->make('_wizhiCoreTaxonomyAdd', ['fields' => $this->fields])->render();
    }
    ...
    public function displayEditFields($term)
    {
        ...
        foreach ($this->fields as $field) {
            ...
            echo $this->view->make('_wizhiCoreTaxonomyEdit', ['field' => $field])->render();
        }
    }
    ...
    {
        wp_nonce_field('taxonomy_set_fields', '_wizhinonce');
    }
     ...
     * 
     * @param int                           $term_id
     * @param \Wizhi\Field\Fields\IField $field
     * @param string                        $value
     *
     * @return mixed|string
     */
    ...
    {
        if (!isset($_POST['_wizhinonce']) || !wp_verify_nonce($_POST['_wizhinonce'], 'taxonomy_set_fields')) {
            return;
        }
