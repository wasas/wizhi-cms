...
class TaxFieldRenderer
{
    ...
    private static function media($typeOfPage, array $field, \stdClass $term = null)
    {
        ...
        ?>
    	    ...
    	    <table class="wizhi-media-table">
					
				<tbody>
				
					<tr class="wizhi-field-media">
					
						<td class="wizhi-media-input">
        ...
        ?>-field" />
						...
						<td>
						    <button type="button" class="button-primary wizhi-media-button" id="wizhi-media-add"><?php _e('Add', 'wizhi');
        ?></button>
						</td>
						
						<td>
						    <button type="button" class="button wizhi-media-clear" id="wizhi-media-clear"><?php _e('Clear', 'wizhi');
        ?></button>
						</td>
