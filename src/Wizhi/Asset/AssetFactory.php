...
class AssetFactory
{
    ...
    public function add($handle, $path, $deps = [], $version = '1.0', $mixed = null, $type = '')
    {
         ...
         */
        if (empty($t)) {
            return new \WP_Error('asset', sprintf('%s: %s. %s', __("Can't load your asset", 'wizhi'), $handle, __('If your asset has no file extension, please provide the type parameter.', 'wizhi')));
        }
