...
class GambitPBSandwichShortcodeBBPress {
    ...
    function __construct() {
        if( is_admin() ) {
            add_filter( 'bbp_default_styles', [ $this, 'sandwich_bbpress_enqueue_editor_styles' ] );
            add_action( 'init', [ $this, 'sandwich_bbp_shortcodes' ], 11 );
        }
    }
    ...
    public function sandwich_bbp_shortcodes() {
        ...
        shortcode_ui_register_for_shortcode( 'bbp-single-forum', [
        ...
        shortcode_ui_register_for_shortcode( 'bbp-topic-form', [
        ...
        shortcode_ui_register_for_shortcode( 'bbp-single-topic', [
        ...
        shortcode_ui_register_for_shortcode( 'bbp-single-reply', [
        ...
        shortcode_ui_register_for_shortcode( 'bbp-single-tag', [
        ...
        shortcode_ui_register_for_shortcode( 'bbp-single-view', [
