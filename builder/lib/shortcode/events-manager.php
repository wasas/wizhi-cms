...
function sandwich_events_manager() {
    ...
    shortcode_ui_register_for_shortcode( 'events_list', [
    ...
    shortcode_ui_register_for_shortcode( 'events_list_grouped', [
    ...
    shortcode_ui_register_for_shortcode( 'event', [
    ...
    shortcode_ui_register_for_shortcode( 'event_form', [
    ...
    shortcode_ui_register_for_shortcode( 'event_search_form', [
    ...
    shortcode_ui_register_for_shortcode( 'events_calendar', [
