...
function sandwich_progressbar() {
    ...
    shortcode_ui_register_for_shortcode( 'pbs_progressbar', [
...
function sandwich_progressbar_shortcode( $attr, $content ) {
    ...
    <div class="sandwich">
        <div class="progress">
            <div id="progressbar-<?php echo esc_attr( $_sandwich_progressbar_id++ ) ?>"
                 class="progress-bar<?php echo esc_attr( $additions ) ?>" role="progressbar" aria-valuemin="0"
                 aria-valuenow="<?php echo esc_attr( $attr[ 'percentage' ] ) ?>" aria-valuemin="0" aria-valuemax="100"
                 style="<?php echo $styling ?>">
