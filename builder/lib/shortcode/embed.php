 ...
 * Convert all "src" syntax into [embed]...[/embed] syntax, but only when editing, everything works fine in the
 * frontend anyway Fixes #147: Inserting a video via Insert from URL doesn't work
 */
...
function sandwich_embed_media() {
    ...
    shortcode_ui_register_for_shortcode( 'embed', [
...
function embed_fix_shortcode_ui_before_do_shortcode( $shortcode ) {
    ...
    add_shortcode( 'embed', [ $wpEmbed, 'shortcode' ] );
}